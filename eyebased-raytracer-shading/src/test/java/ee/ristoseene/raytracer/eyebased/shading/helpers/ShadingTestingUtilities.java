...
public interface ShadingTestingUtilities {
    ...
    @SuppressWarnings("unchecked")
    static ShadingContext createShadingContextMock(RayIntersectionContext rayIntersectionContext, Map<TypedAttribute, Object> attributesMap) {
        ShadingContext shadingContext = createShadingContextMock(rayIntersectionContext, false);
