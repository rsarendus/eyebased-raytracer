...
public class VertexPositionProvider implements CompiledVertexAttributeProvider<Vector3.Accessible> {

    private final VertexAttributeSource vertexAttributeSource;

    public VertexPositionProvider(final VertexAttributeSource vertexAttributeSource) {
