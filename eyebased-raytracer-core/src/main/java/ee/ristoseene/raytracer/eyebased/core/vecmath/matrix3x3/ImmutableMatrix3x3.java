...
public class ImmutableMatrix3x3 implements Matrix3x3.Accessible {
	...
	public ImmutableMatrix3x3(double Xx, double Xy, double Xz, double Yx, double Yy, double Yz, double Zx, double Zy, double Zz) {
		this.Xx = Xx;
		this.Xy = Xy;
		this.Xz = Xz;
		this.Yx = Yx;
	...
	public ImmutableMatrix3x3(Value.Accessible Xx, Value.Accessible Xy, Value.Accessible Xz, Value.Accessible Yx, Value.Accessible Yy, Value.Accessible Yz, Value.Accessible Zx, Value.Accessible Zy, Value.Accessible Zz) {
		this.Xx = Xx.get();
		this.Xy = Xy.get();
		this.Xz = Xz.get();
		this.Yx = Yx.get();
	...
	public ImmutableMatrix3x3(Vector3.Accessible X, Vector3.Accessible Y, Vector3.Accessible Z) {
		this.Xx = X.x();
		this.Xy = X.y();
		this.Xz = X.z();
		this.Yx = Y.x();
