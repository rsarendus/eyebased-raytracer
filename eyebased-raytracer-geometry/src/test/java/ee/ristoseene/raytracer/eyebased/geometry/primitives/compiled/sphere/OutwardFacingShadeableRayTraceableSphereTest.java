...
public class OutwardFacingShadeableRayTraceableSphereTest extends AbstractShadeableRayTraceableSphereTest {

    @Override
    protected OutwardFacingShadeableRayTraceableSphere createInstance(final OutwardFacingShadeableRayTraceableSphere.Configuration configuration, final double diameter) {
